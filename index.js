...
module.exports.pitch = function (remainingRequest) {
  ...
  // css import from kdu file --> component lifecycle linked
  // style embedded in kdu file --> component lifecycle linked
  var isKdu = /"kdu":true/.test(remainingRequest)
  ...
  if (!isServer) {
    ...
    // on the server: attach to Kdu SSR context
    if (isKdu) {
      // inside *.kdu file: expose a function so it can be called in
